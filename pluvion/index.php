                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                        ...
                        foreach($json_channel['channels'] as $item_channel) {
                            ...
                            $json = json_decode($content, true);							$counter = $counter +1;

                            echo "<tr>";	                        echo "<td class='stationName'>";                            echo $counter;                            echo "</td>";
                            ...
                            foreach($json['feeds'] as $item) {
                                ...
                                echo "<td class='$clazz'>";
                                    ...
                                    echo ' &deg;C';
                                echo "</td>";								
                                echo "<td class='$clazz'>";                                    echo $item['field2'];                                    echo ' %';                                echo "</td>";								
                                echo "<td class='$clazz'>";
                                    echo $item['field4'];
                                    echo ' mm';
                                echo "</td>";
